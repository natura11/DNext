...
Feature: Abel Activation
  ...
  Scenario:As a user, I want complete Abel Activation process successfully  on Customer360 search page
    ...
    And   User fills in enter Customer name field with valid name as "CLARISSA MAYER AUTOMATION" on Customer360 search page
...
#    When  User selects the "Digitalb Premium Plus" product on DSales Product page
    ...
    And   User selects the "Abel" as infrastructure on Product Detail page
    ...
    Then  User should see the "Akses Fee per Dekoder Basic" product is added on Shopping Cart Page
