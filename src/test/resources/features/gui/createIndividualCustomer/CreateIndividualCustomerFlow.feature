...
Feature:New Individual Customer-Customer Creation
  ...
  @individualCustomerCreationWithHappyPathXZFSDZFDZFF
  Scenario: As a user I want to create an Individual Customer rtdstsdrtsdrt


    Then  User is in the Address Information on Create Individual Customer page
    And   User clicks Address Line 1 Field for Service Address in Address Information on Create Individual Customer page
    And   User enters a value "FIRST SERVICE ADDRESS" in the Address Line 1 textbox for Service Address in Address Information on Create Individual Customer page
    And   User selects random city on Individual Address Information page
    And   User clicks Next button in Address Information on Create Individual Customer page
    Then  User is in the Contact Information on Create Individual Customer page
    When  User clicks Type of Authorization dropdown on Individual Contact Information Page
    And   User selects "Legal Custodian" option in the Authorization dropdown on Individual Contact Information Page
    And   User clicks Identification Number textbox on Contact Information Page
    ...
    And   User should selects any option in the Currency dropdown on Individual Invoice Account page
    ...
    When  User clicks Save button on Individual Other Information page
    Then  User should see the "Customer created successfully" snake message
    Then  User should see the Main Page of customer